...
/*******************************************************************************
 函数名称  :    miniflow_extract
 功能描述  :    从报文提取mini flow
 				key值的提取,提取L2、L3、L4的报文协议头
 输入参数  :  	
 输出参数  :	
 返 回 值  : 	无
-----------------------------------------------------------------------------
...
/*******************************************************************************
 函数名称  :    miniflow_hash_5tuple
 功能描述  :    根据miniflow计算的哈希值
 输入参数  :    flow---报文提取的miniflow
 输出参数  :	
 返 回 值  : 	无
-----------------------------------------------------------------------------
---
