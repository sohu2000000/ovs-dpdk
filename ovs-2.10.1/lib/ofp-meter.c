...
/*******************************************************************************
 函数名称  :    ofputil_encode_meter_request
 功能描述  :    封装meter流表的请求
 输入参数  :  	
 输出参数  :	
 返 回 值  : 	msg---申请的of消息结构
...
/*******************************************************************************
 函数名称  :    ofputil_decode_meter_stats
 功能描述  :    解析meter 流量统计
 输入参数  :  	
 输出参数  :	
 返 回 值  : 	无
...
/*******************************************************************************
 函数名称  :    parse_ofp_meter_mod_str__
 功能描述  :    解析meter 流表，流表实例: ovs-ofctl -O OpenFlow13 add-meter s1 meter=3,kbps,burst,band=type=drop,rate=5000,burst_size=5000
 输入参数  :  	mm---meter流表配置，解析出的配置存入mm
 				str--meter流表具体内容，来源于meter流表
 				bands--带宽信息解析到bands
 				command---OFPMC13_ADD 下发流表
                          ...
                          enum ofputil_protocol *usable_protocols)
{
    ...
    *usable_protocols = OFPUTIL_P_OF13_UP;
	...
	/*如果是下发meter流表，至少开启meter flag  带宽*/
    case OFPMC13_ADD:
...
/*******************************************************************************
 函数名称  :    parse_ofp_meter_mod_str
 功能描述  :    解析meter流表
 输入参数  :  	mm---解析出的meter流表配置
 				str--meter流表具体内容，来源于meter流表
 				command---OFPMC13_ADD 下发流表
 输出参数  :	
 返 回 值  : 	无
                        ...
                        int command, enum ofputil_protocol *usable_protocols)
{
	...
	/*解析meter 流表，配置存入mm，带宽存入bands*/
    error = parse_ofp_meter_mod_str__(mm, string, &bands, command, usable_protocols);
