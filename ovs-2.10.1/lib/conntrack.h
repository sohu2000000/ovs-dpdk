...
struct conntrack_bucket {
    ...
    struct hmap connections OVS_GUARDED;											/*链接hamp*/
    ...
    struct ovs_list exp_lists[N_CT_TM] OVS_GUARDED;									/*不同类型的超时链表*/
