...
/*******************************************************************************
 函数名称  :    dpif_port_add
 功能描述  :    
 输入参数  :  	name---路径/usr/local/var/run/openvswitch/ovs-vswtichd.pid.ctl
 输出参数  :	
 返 回 值  : 	无
-----------------------------------------------------------------------------
---
                 ...
                 int *dirfdp, char linkname[MAX_UN_LEN + 1])
{
    ...
    *dirfdp = -1;
	...
	/*链接的地址 路径/usr/local/var/run/openvswitch/ovs-vswtichd.pid.ctl*/
...
/*******************************************************************************
 函数名称  :    make_unix_socket
 功能描述  :    打开unix_socket
 输入参数  :  	style---SOCK_STREAM
 				nonblock---true非阻塞方式打开
 				bind_path---NULL
 				connect_path---/usr/local/var/run/openvswitch/ovs-vswtichd.pid.ctl
 输出参数  :	
 返 回 值  : 	无
-----------------------------------------------------------------------------
---
