...
struct ovsthread_key {
    struct ovs_list list_node;  /* In 'inuse_keys' or 'free_keys'. */			/*ovs 链表头*/
    void (*destructor)(void *); /* Called at thread exit. */					/*线程退出函数*/
