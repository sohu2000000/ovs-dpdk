...
/*******************************************************************************
 函数名称  :    dp_packet_clone
 功能描述  :    报文拷贝
 输入参数  :  	buffer---批处理单个报文buffer
 输出参数  :	
 返 回 值  : 	无
--------------------------------------------------------------------------------
 最近一次修改记录 :
...
/*******************************************************************************
 函数名称  :    dp_packet_clone_with_headroom
 功能描述  :    报文clone到新buffer
 输入参数  :  	buffer---批处理单个报文buffer
 				headroom---0
 输出参数  :	
 返 回 值  : 	无
...
dp_packet_clone_with_headroom(const struct dp_packet *buffer, size_t headroom)
{
	...
	/*创建新buffer，dpdk的报文buffer*/
    new_buffer = dp_packet_clone_data_with_headroom(dp_packet_data(buffer), dp_packet_size(buffer), headroom);
...
/*******************************************************************************
 函数名称  :    dp_packet_prealloc_headroom
 功能描述  :    确保headroom足够长来放tnl head
 输入参数  :  	
 输出参数  :	
 返 回 值  : 	无
--------------------------------------------------------------------------------
...
/*******************************************************************************
 函数名称  :    dp_packet_push_uninit
 功能描述  :    data左偏了tnl head长度，mbuf 包长加上了tnl head
 输入参数  :  	size--外层头长度
 输出参数  :	
 返 回 值  : 	无
--------------------------------------------------------------------------------
...
{
	/*确保headroom足够长来放tnl head*/
    dp_packet_prealloc_headroom(b, size);

	/*修改data 起始位置，左偏加上了tnl head*/
    dp_packet_set_data(b, (char*)dp_packet_data(b) - size);
