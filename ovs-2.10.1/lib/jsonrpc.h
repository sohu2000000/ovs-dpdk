...
/*rpc消息*/
struct jsonrpc_msg {
    enum jsonrpc_msg_type type;													/*rpc的消息类型 请求、回应*/
    char *method;               /* Request or notification only. */				/*方法，请求*/
    struct json *params;        /* Request or notification only. */				/*dpcl/add-flow "flow"*/
    struct json *result;        /* Successful reply only. */					/*成功reply*/
    struct json *error;         /* Error reply only. */							/*reply错误信息*/
    struct json *id;            /* Request or reply only. */					/*消息id*/
};
