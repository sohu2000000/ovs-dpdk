...
/*******************************************************************************
 函数名称  :    vconn_open
 功能描述  :    打开虚拟链接 socket或其他
 输入参数  :  	name---unix:/usr/local/var/run/openvswitch/br-vrouter.socket
 输出参数  :	
 返 回 值  : 	无
--------------------------------------------------------------------------------
 最近一次修改记录 :
...
/*******************************************************************************
 函数名称  :    emc_cache_slow_sweep
 功能描述  :    从vconn非阻塞收包，收不到报文返回EAGAIN
...
/*******************************************************************************
 函数名称  :    vconn_send
 功能描述  :    非阻塞模式发送，别其他路径丢了不感知，这样消息就到不了对端
 输入参数  :  	
 输出参数  :	
 返 回 值  : 	无
--------------------------------------------------------------------------------
...
/*******************************************************************************
 函数名称  :    vconn_transact_multiple_noreply
 功能描述  :    emc流表删除
 输入参数  :  	vconn---虚拟链接
 				requests---请求
 				replyp---回应消息
