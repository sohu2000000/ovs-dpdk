...
/*******************************************************************************
 函数名称  :	ovs_internal_dev_get_vport
 功能描述  :	从网络设备获取虚拟端口
 输入参数  :	
 输出参数  :	
 返 回 值  :	无
...
/*******************************************************************************
 函数名称  :	ovs_internal_dev_rtnl_link_register
 功能描述  :	注册netlink操作函数和虚拟端口操作函数
 输入参数  :  
 输出参数  :	
 返 回 值  :	无
--------------------------------------------------------------------------------
...
int ovs_internal_dev_rtnl_link_register(void)
{
	...
	/*netlink操作函数internal_dev_link_ops注册到全局netlink链link_ops*/
	err = rtnl_link_register(&internal_dev_link_ops);
	if (err < 0)
		return err;

	/*虚拟端口全局操作函数ovs_internal_vport_ops挂入全局链vport_ops_list*/
