...
struct ds {
    char *string;       /* Null-terminated string. */											/*字符串*/
    size_t length;      /* Bytes used, not including null terminator. */						/*已使用的字节数*/
    size_t allocated;   /* Bytes allocated, not including null terminator. */					/*申请的内存总字节数*/
};
