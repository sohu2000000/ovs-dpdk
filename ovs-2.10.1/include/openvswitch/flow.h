...
struct flow {
    /* Metadata */
    struct flow_tnl tunnel;     /* Encapsulating tunnel parameters. */					/*隧道报文信息*/
    ovs_be64 metadata;          /* OpenFlow Metadata. */								/*open flow的metadata*/
    ...
    ovs_be32 mpls_lse[ROUND_UP(FLOW_MAX_MPLS_LABELS, 2)]; /* MPLS label stack
                                                             (with padding). */
    /* L3 (64-bit aligned) */
    ovs_be32 nw_src;            /* IPv4 source address or ARP SPA. */					/*sip地址 偏移地址/8=30 */
