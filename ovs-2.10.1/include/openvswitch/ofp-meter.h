...
struct ofputil_meter_config {
    ...
    uint16_t flags;
    uint16_t n_bands;
    struct ofputil_meter_band *bands;   /*带宽配置*/
};
...
struct ofputil_meter_mod {
    uint16_t command;							/*meter操作命令*/
    struct ofputil_meter_config meter;		/*meter的配置*/
};
