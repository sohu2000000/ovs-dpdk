...
/*vsctl iface接口*/
struct vsctl_iface {
    struct ovs_list ifaces_node; /* In struct vsctl_port's 'ifaces' list. */		/*接口链表*/
    struct ovsrec_interface *iface_cfg;												/*接口配置*/
    struct vsctl_port *port;														/*端口*/
};
