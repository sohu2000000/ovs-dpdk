...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    open_vconn_socket
 ¹¦ÄÜÃèÊö  :    ´ò¿ªÒ»¸öÐéÄâÁ´½Ó£¬socket»òÆäËû
 ÊäÈë²ÎÊý  :  	name---Â·¾¶/usr/local/var/run/openvswitch/br-vrouter.socket
 				vconnp---ÐéÄâÁ´½Ó½á¹û
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    open_vconn__
 ¹¦ÄÜÃèÊö  :    ´ò¿ªÓëdpÍ¨ÐÅµÄsocket»òÆäËûÐéÄâÁ´½Ó£¬·µ»ØÖ§³ÖµÄopenflowÐ­Òé
 ÊäÈë²ÎÊý  :  	name---br ÍøÇÅname br-docker1
 				vconnp---ÐéÄâÁ´½Ó
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
...
open_vconn__(const char *name, enum open_target target,
             struct vconn **vconnp)
{
	/*¶Ô¶Ë´¦ÀíopenflowÓÃµÄÀàÐÍ£¬ÓÃµÄÊÇovsµÄÍøÂçÁ´½Ó¹ÜÀí*/
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    dump_transaction
 ¹¦ÄÜÃèÊö  :    
 ÊäÈë²ÎÊý  :  	vconn---ÐéÄâÁ´½Ó Á´½Óµ½Ò»¸öopenflowÉè±¸
 				request--ofÇëÇóÏûÏ¢
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    transact_multiple_noreply
 ¹¦ÄÜÃèÊö  :    ·¢ÏûÏ¢£¬·¢µôËùÓÐµÄÇëÇó£¬Ö»ÓÐÓÐ´íÎóÊ±²ÅÓÐ»ØÓ¦£
 ÊäÈë²ÎÊý  :  	vconn---×ßµÄÁ´½Ó
 				requests---ÇëÇóÏûÏ¢Á´±í
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
 ×î½üÒ»´ÎÐÞ¸Ä¼ÇÂ¼ :
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    transact_noreply
 ¹¦ÄÜÃèÊö  :    ·¢ÏûÏ¢£¬µÈ´ý»ØÓ¦
 ÊäÈë²ÎÊý  :  	vconn---ÐéÄâÁ´½Ó
 				request---ÇëÇóÏûÏ¢
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    open_vconn_for_flow_mod
 ¹¦ÄÜÃèÊö  :    ´ò¿ªopenflow dpÐéÄâÁ´½Ó£¬Êµ¼Ê×ßµÄsocket
 ÊäÈë²ÎÊý  :  	remote---br ÍøÇÅ 
 				vconnp---´ò¿ªÐéÄâÁ´½Ó´æÈëvconnp
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
 ×î½üÒ»´ÎÐÞ¸Ä¼ÇÂ¼ :
                        ...
                        enum ofputil_protocol usable_protocols)
{
	...
	/*´ÓÍøÇÅ´ò¿ªÐéÄâÁ´½Ó´æÈëvconnp£¬ofctl×ßµÄUnix socket*/
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    ofctl_flow_mod__
 ¹¦ÄÜÃèÊö  :    ´ò¿ªÒ»¸öÖ¸Ïòovs-vswitchdµÄsocket£¬½«flow match±ä³ÉopenflowµÄÐ­Òé£¬·¢³öÈ¥transact_noreply
 ÊäÈë²ÎÊý  :  	
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
...
ofctl_flow_mod(int argc, char *argv[], uint16_t command)
{
    if (argc > 2 && !strcmp(argv[2], "-")) {
		...
		/*¿ªÒ»¸öÖ¸Ïòovs-vswitchdµÄsocket£¬½«flow match±ä³ÉopenflowµÄÐ­Òé£¬·¢³öÈ¥transact_noreply*/
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    ofctl_meter_mod__
 ¹¦ÄÜÃèÊö  :    of²ãmeterÁ÷±íÏÂ·¢£oÀý×Ó: ovs-ofctl mod-meter <bridge> meter=<id>,kbps[,burst,stats],band=type=<type>,rate=<rate>,burst_size=<size>,prec_level=<level
 ÊäÈë²ÎÊý  :  	bridge---meter Á÷±íËùÏÂ·¢µÄbr br-docker1
 				str---meterÁ÷±í¾ßÌåµÄÅäÖÃ
 				command---OFPMC13_ADD ÏÂ·¢Á÷±í
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
 ×î½üÒ»´ÎÐÞ¸Ä¼ÇÂ¼ :
...
ofctl_meter_mod__(const char *bridge, const char *str, int command)
{
    ...
    if (str) {
		...
		/*½âÎömeter Á÷±í£¬ÅäÖÃ´æÈëmm£¬´ø¿í´æÈëbands*/
	...
	/*´ò¿ªÐéÄâÁ´½Ó£¬Êµ¼Ê×ßµÄunix socket£¬·µ»ØÖ§³ÖµÄopenflowÐ­Òé£¬ÐéÄâÁ´½Ó´æÈëvcoon*/
    protocol = open_vconn_for_flow_mod(bridge, &vconn, usable_protocols);

	/*Ð­ÒéµÄ°æ±¾*/
    version = ofputil_protocol_to_ofp_version(protocol);

	/*´Óunix socketÁ´½ÓÐéÄâÁ´½Ó·¢ÇëÇóÏûÏ¢£¬ÏÂ·¢meter Á÷±í*/
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    ofctl_meter_request__
 ¹¦ÄÜÃèÊö  :    meterÁ÷±í²Ù×÷ÇëÇó
 ÊäÈë²ÎÊý  :  	
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
...
/*******************************************************************************
 º¯ÊýÃû³Æ  :    ofctl_dump_meters
 ¹¦ÄÜÃèÊö  :    dump meterÁ÷±í
 ÊäÈë²ÎÊý  :  	
 Êä³ö²ÎÊý  :	
 ·µ »Ø Öµ  : 	ÎÞ
--------------------------------------------------------------------------------
