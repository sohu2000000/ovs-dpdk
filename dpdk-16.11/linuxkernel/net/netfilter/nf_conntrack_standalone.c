...
/*******************************************************************************
 函数名称 :  nf_conntrack_standalone_init_proc
 功能描述 :  
 输入参数 :  
 输出参数 :  无
 返回值　 :  无
...
static int nf_conntrack_standalone_init_sysctl(struct net *net)
{
	...
	/*注册sysctl table nf conntrack的sysctl命令*/
...
/*******************************************************************************
 函数名称 :  nf_conntrack_standalone_init
 功能描述 :  nf_conntrack网络空间子系统注册进了内核
 输入参数 :  
 输出参数 :  无
 返回值　 :  无
 --------------------------------------------------------------------------------
...
{
	/*完成连接跟踪基础参数的初始化，hash slab 扩展项,最大链接数，哈希表设置*/
...
/*ct模块 sysctl tables注册*/
#ifdef CONFIG_SYSCTL
	nf_ct_netfilter_header = register_net_sysctl(&init_net, "net", nf_ct_netfilter_table);
...
/*******************************************************************************
 函数名称 :  nf_conntrack_standalone_fini
 功能描述 :  卸载
 输入参数 :  
 输出参数 :  无
 返回值　 :  无
